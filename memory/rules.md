...
7. 특정 주제와 관련된 item이 늘어나면 `indexes/`에 주제 인덱스를 만든다.
8. 필요하면 task, decision, wiki 문서에서 관련 index를 링크한다.
...
- task, decision, wiki 문서는 관련된 index를 링크할 수 있다.
...
- `wiki/`는 작업 운영보다 설명과 정리에 가깝고, 필요할 때 issue / task / decision에서 링크해 사용한다.
