...
- Description: Implements the lwjgl wrap operation.
- Value: `new LWJGLWrap()`
...
- Role: Handles the ckbuf path.
- Description: Implements the ckbuf operation.
...
- Role: Handles the cksrcbuf path.
- Description: Implements the cksrcbuf operation.
