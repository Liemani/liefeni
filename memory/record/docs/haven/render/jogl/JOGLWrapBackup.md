...
Adapts the render backend to JOGL for joglwrap backup.
...
- Role: Creates a new JOGLWrapBackup instance.
- Description: Constructs the JOGLWrapBackup instance from the supplied inputs.
