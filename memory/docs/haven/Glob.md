...
This file documents the responsibilities and members of `Glob`.
...
Owns the global world state and shared scene context.

## Nested Types

### CAttr

- Role: Represents cattr within Glob.
- Description: Describes the nested cattr type used by the enclosing class.

### FrameInfo

- Role: Represents frame info within Glob.
- Description: Describes the nested frame info type used by the enclosing class.

### Weather

- Role: Represents weather within Glob.
- Description: Describes the nested weather type used by the enclosing class.
...
- Role: Creates a new Glob instance.
