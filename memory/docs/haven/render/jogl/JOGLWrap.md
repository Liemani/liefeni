...
This file documents the responsibilities and members of `JOGLWrap`.
...
- Role: Defines the shared joglerrp constant.
...
- Role: Performs xlatejoglexc.
- Description: Supports the xlatejoglexc operation used by the surrounding class.
